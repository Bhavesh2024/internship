    ...
    <>
       {
        ...
        <button className=" bg-gradient-to-r from-slate-900 to-gray-800 rounded-full py-2 px-5 text-white inline-block w-fit text-sm my-3" onClick={handleProduct}>
					Add to Cart
				</button> : <button className='bg-gradient-to-r from-indigo-900 to-blue-800 rounded-md py-2 px-5 text-white inline-block w-fit text-sm my-3' onClick={() => navigate(`/user/${username}/cart`)}> Go to Cart</button> 
        }
    </>
  )
}
